...
class VDAgentManager:
    """Manages the SPICE vdagent for guest<->host integration.

    Handles:
      - Shared clipboard (host<->guest text copy/paste)
      - Drag-and-drop file transfer
      - Automatic display resolution adjustment
      - Mouse pointer integration (absolute positioning)
    """
